            ...
            ?>
                    <article class="swiper-slide cartao_produto">
                        ...
                        <div class="produto_rodape">
                            ...
                            <form method="POST" action="<?= BASE_URL ?>/app/control/ClienteController.php?acao=tela_inicial" target="favorito_target" class="form-favorito" data-favorito-uid="prod_<?= $idProduto ?>" style="display: inline;">
